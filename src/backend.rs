...
//    Display, GlobalManager, Main, WEnum,
//};
...
pub fn write_to_file(
    ...
    match encoding_format {
        EncodingFormat::Jpg => {
            JpegEncoder::new(output_file.by_ref()).write_image(
        ...
        EncodingFormat::Png => {
            PngEncoder::new(output_file.by_ref()).write_image(
                &frame_copy.frame_mmap,
                frame_copy.frame_format.width,
                frame_copy.frame_format.height,
                frame_copy.frame_color_type,
        ...
        EncodingFormat::Ppm => {
            ...
            PnmEncoder::new(output_file.by_ref())
